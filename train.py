...
class Train:
    ...
    def __init__(self,root):
        ...
        # backgorund image 
        bg1=Image.open("Images_GUI/data_train.png")
        ...
        # ------------------------------------------------------------------------------------------------------------------- 
        # Training button 1
        std_img_btn=Image.open("Images_GUI/data_training.png")
        ...
        std_b1_1 = Button(bg_img,command=self.train_classifier,text="Data Training",cursor="hand2",font=("tahoma",15,"bold"),bg="white",fg="navyblue")
        std_b1_1.place(x=600,y=460,width=180,height=45)
