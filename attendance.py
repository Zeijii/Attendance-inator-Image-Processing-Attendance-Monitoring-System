...
class Attendance:
    ...
    def __init__(self,root):
        ...
        self.attendanceReport_left.heading("ID",text="Class no.")
        self.attendanceReport_left.heading("Roll_No",text="Student no.")
        ...
        self.attendanceReport.heading("ID",text="Class.no")
        self.attendanceReport.heading("Roll_No",text="Student no.")
